...
class TechnologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create technology' do
    assert_difference('Technology.count') do
      post technologies_url, params: { technology: { description: @technology.description, name: @technology.name } },
                             as: :json
    end
  ...
  test 'should update technology' do
    patch technology_url(@technology),
          params: { technology: { description: @technology.description, name: @technology.name } }, as: :json
    assert_response 200
  end
